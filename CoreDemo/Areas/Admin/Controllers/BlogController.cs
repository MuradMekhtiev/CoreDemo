    ...
    public class BlogController : Controller
    {
        public IActionResult ExportStaticExelBlogList()
        {
            using (var workbook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    return File(content, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Calishma1.xlsx");
                }
            }
        }
        public List<BlogModel> GetBlogList()
        {
            List<BlogModel> bm = new List<BlogModel>
            {
                ...
                new BlogModel {ID = 2, BlogName = "Tesla Cars"},
                new BlogModel {ID = 3, BlogName = "2022 World Cup"}
            };
            return bm;
        }
